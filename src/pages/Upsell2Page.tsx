    ...
    <div className="min-h-screen bg-white selection:bg-brand-pink selection:text-white overflow-hidden">
        ...
        >
          ...
          >
            ...
            <div className="relative rounded-[40px] overflow-hidden shadow-2xl border-4 border-white">
              <img 
                src="https://i.ibb.co/jZkQFm9m/76494007-7847-40fe-98f8-fe0898bd15cb-1778016757214.avif" 
          ...
          <div className="mb-8">
             ...
             <h2 className="text-2xl md:text-4xl font-black text-slate-800 tracking-tighter leading-none italic">
               ...
               <span className="text-brand-purple">LEVAR O COMBO VIP POR R$ 23,90</span>
             </h2>
          </div>
        </motion.div>
      </header>
      ...
      <section className="pb-32 px-6 relative">
        <div className="max-w-md mx-auto">
          <OfferCard 
            title="Pacote Completo Estilos de Dança Infantil (K-pop, Zumba Kids, Sapateado e Mais)"
            price="23"
            originalPrice="197"
            icon={StarIcon}
            highlight={true}
            ...
            ctaUrl="https://ggcheckout.app/checkout/v5/sGA5bUYt9xQTuZ1HTA9d"
          />
        </div>
